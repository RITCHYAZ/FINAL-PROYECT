...
$mod=mysql_query("delete from carrito where id_carro='$id' AND clave='$clav'")or die(mysql_error());
...
<form id="form1" name="form1" method="post" action="">
  <table width="85%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td>$<?php $TOTS=$res['precio']*$res['cantidad']; echo number_format($TOTS,2,".",",")?></td>
